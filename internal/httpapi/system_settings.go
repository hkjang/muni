...
func (s *Server) saveSettings(w http.ResponseWriter, r *http.Request) {
	...
	s.audit(r, &p.User.ID, "UPDATE_SETTINGS", "SETTINGS", nil, map[string]any{"categories": []string{"general", "oidc", "ai", "workflow", "security", "export", "ptium", "retention", "smtp", "tracking"}})

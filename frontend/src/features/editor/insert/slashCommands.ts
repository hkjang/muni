...
export const insertCommands: InsertCommand[] = [
  { id: "h1", label: "제목 1", keywords: "heading title h1 제목", group: "서식", hint: "# " },
  { id: "h2", label: "제목 2", keywords: "heading h2 제목", group: "서식", hint: "## " },
  { id: "h3", label: "제목 3", keywords: "heading h3 제목", group: "서식", hint: "### " },
  { id: "paragraph", label: "본문", keywords: "paragraph text body 본문", group: "서식" },
  { id: "bulletList", label: "글머리 기호 목록", keywords: "bullet list ul 목록", group: "서식", hint: "- " },
  { id: "orderedList", label: "번호 매기기 목록", keywords: "ordered list ol number 목록 번호", group: "서식", hint: "1. " },
  { id: "taskList", label: "체크리스트", keywords: "task todo checklist 체크 할일", group: "서식" },
  { id: "blockquote", label: "인용", keywords: "quote blockquote 인용", group: "서식", hint: "> " },
  { id: "codeBlock", label: "코드 블록", keywords: "code block 코드", group: "서식", hint: "```" },
 ...
 */
export function readSlashQuery(textBefore: string): { query: string; length: number } | null {
